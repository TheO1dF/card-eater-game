...
const SHOP_CARD_DEFS = [
  ...
  card({ id: "F005", sprite_x: 0, sprite_y: 0, sprite_hue: 55, name: "金苹果", rarity: "罕见", max_copies: 2, type: "水果", edibility: EDIBLE, eat_points: 2, discard_points: 0, role: ENGINE, synergy_tags: ["水果", "成长", "重洗"], effect: { kind: "permanent_growth_eat", description: "每次吃掉，自身吃分永久 +1；重洗后再次吃仍可成长", amount: 1 } }),
  ...
  card({ id: "D005", sprite_x: 0, sprite_y: 1, sprite_hue: 28, name: "糖果", rarity: "普通", type: "甜点", edibility: EDIBLE, eat_points: 1, discard_points: 0, role: ENGINE, synergy_tags: ["甜点", "储存", "重洗"], effect: { kind: "store_or_cashout", description: "吃掉：这张实体牌储存 +3 分（最多 6）；弃掉：获得已储存分数并清空储存", store_action: "eat", cashout_action: "discard", amount: 3, max_stored: 6 } }),
  ...
  card({ id: "F009", name: "发芽种子", rarity: "罕见", max_copies: 3, type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: ENGINE, synergy_tags: ["水果", "成长", "重洗"], effect: { kind: "permanent_growth_condition", description: "本轮重洗后每次吃掉，自身吃分成长 +2", trigger_action: "eat", condition: "reshuffled", grow_stat: "eat_points", amount: 2, keywords: ["重洗"] } }),
  ...
  card({ id: "U007", name: "收银台", rarity: "普通", max_copies: 2, type: "通用", edibility: INEDIBLE, eat_points: -1, discard_points: -2, role: ECONOMY, synergy_tags: ["通用", "经济", "摧毁"], effect: { kind: "shop_free_reroll_destroy", description: "弃掉 -2；摧毁自身，使随后商店获得 2 次免费刷新", trigger_action: "discard", count: 2 } }),
  ...
  card({ id: "U008", name: "袖珍洗牌机", rarity: "罕见", max_copies: 2, type: "通用", edibility: INEDIBLE, eat_points: -3, discard_points: 0, role: ENGINE, synergy_tags: ["通用", "重洗", "摧毁"], effect: { kind: "gain_reshuffle_charge_destroy", description: "弃掉：摧毁自身；若摧毁后牌组不超过 10 张，本轮重洗次数 +1", trigger_action: "discard", max_deck_size: 10, count: 1 } }),
  ...
  card({ id: "F010", name: "橙子", rarity: "普通", max_copies: 2, type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: 0, role: ECONOMY, synergy_tags: ["水果", "经济", "规模"], effect: { kind: "gold_from_deck_type", description: "每轮首次吃掉：牌组中每有 3 张水果，结算金币 +1（最多 +3）", trigger_action: "eat", target_type: "水果", divisor: 3, gold: 1, max_gold: 3, once_per_round: true } }),
  ...
  card({ id: "F015", name: "丰收篮", rarity: "传奇", min_shop_round: 8, max_copies: 1, type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -3, role: PAYOFF, synergy_tags: ["水果", "多样性", "大牌组"], effect: { kind: "scale_by_unique_deck", description: "牌组中每有 1 种不同名称的水果，吃下额外 +1（最多 +10）", trigger_action: "eat", target_type: "水果", multiplier: 1, max_bonus: 10 } }),

  card({ id: "K006", name: "热狗", rarity: "普通", max_copies: 2, type: "快餐", edibility: EDIBLE, eat_points: 2, discard_points: 0, role: ECONOMY, synergy_tags: ["快餐", "经济", "商店"], effect: { kind: "shop_discount", description: "每轮首次吃掉后，随后商店卡牌价格 -1", trigger_action: "eat", discount: 1, once_per_round: true } }),
  ...
  card({ id: "K008", name: "披萨", rarity: "稀有", min_shop_round: 3, type: "快餐", edibility: EDIBLE, eat_points: 2, discard_points: 0, role: PAYOFF, synergy_tags: ["快餐", "大牌组", "保底"], effect: { kind: "scale_by_deck", description: "牌组中每有 5 张可食用牌，吃下额外 +2（最多 +8）", trigger_action: "eat", target_edibility: EDIBLE, divisor: 5, multiplier: 2, max_bonus: 8 } }),
  ...
  card({ id: "V005", name: "菠菜", rarity: "普通", max_copies: 2, type: "蔬菜", edibility: EDIBLE, eat_points: 1, discard_points: 0, role: SETUP, synergy_tags: ["蔬菜", "蓄势"], effect: { kind: "buff_remaining_type", description: "每轮首次吃掉后，本轮后续每张蔬菜吃分 +1", trigger_action: "eat", action: "eat", target_type: "蔬菜", add: 1, once_per_round: true } }),
  ...
  card({ id: "V008", name: "豆芽", rarity: "普通", max_copies: 2, type: "蔬菜", edibility: EDIBLE, eat_points: 0, discard_points: -1, role: ENGINE, synergy_tags: ["蔬菜", "成长", "累计"], effect: { kind: "permanent_growth_condition", description: "这张实体牌累计每吃 2 次，自身吃分成长 +2；进度跨轮保留", trigger_action: "eat", condition: "every_n_uses", every: 2, grow_stat: "eat_points", amount: 2 } }),
  ...
  card({ id: "C009", name: "卫星", rarity: "普通", max_copies: 2, type: "星体", edibility: INEDIBLE, eat_points: -2, discard_points: 1, role: ECONOMY, synergy_tags: ["星体", "餐盘", "经济", "规模"], effect: { kind: "gold_from_reserve", description: "每轮首次弃掉：若有未登场牌，结算金币 +1；未登场牌达到 5 张时再 +1（最多 +2）", trigger_action: "discard", step: 5, max_gold: 2, once_per_round: true } }),
  ...
  card({ id: "C012", name: "星图", rarity: "罕见", type: "星体", edibility: INEDIBLE, eat_points: -3, discard_points: 1, role: PAYOFF, synergy_tags: ["星体", "多样性", "保底"], effect: { kind: "scale_by_unique_deck", description: "牌组中每有 1 种不同名称的星体，弃掉额外 +2（最多 +8）", trigger_action: "discard", target_type: "星体", multiplier: 2, max_bonus: 8 } }),
  ...
  card({ id: "A012", name: "兔群头领", rarity: "传奇", min_shop_round: 8, max_copies: 1, type: "动物", edibility: INEDIBLE, eat_points: -8, discard_points: 2, role: PAYOFF, synergy_tags: ["动物", "兔子", "编队"], effect: { kind: "rabbit_formation", description: "弃掉时，牌组中每组成 1 对兔子额外 +3（最多 +12）；落单兔子不计分", trigger_action: "discard", rabbit_id: "A004", pair_bonus: 3, max_bonus: 12 } }),
  ...
  card({ id: "P012", name: "队长", rarity: "传奇", min_shop_round: 8, max_copies: 1, type: "人物", edibility: INEDIBLE, eat_points: -8, discard_points: 2, role: PAYOFF, synergy_tags: ["人物", "大牌组", "保底"], effect: { kind: "scale_by_deck", description: "牌组每有 5 张牌，弃掉额外 +2（最多 +12）", trigger_action: "discard", divisor: 5, multiplier: 2, max_bonus: 12 } }),
  ...
  card({ id: "U014", name: "秒表", rarity: "罕见", max_copies: 1, type: "通用", edibility: INEDIBLE, eat_points: -3, discard_points: 1, role: ENGINE, synergy_tags: ["通用", "重洗", "小牌组"], effect: { kind: "gain_reshuffle_charge", description: "牌组不超过 10 张时，每轮首次弃掉：本轮重洗次数 +1", trigger_action: "discard", max_deck_size: 10, count: 1, once_per_round: true } }),
...
const QUEST_CARD_DEFS = [
  card({ id: "Q001", name: "虚空牌", rarity: "诅咒", type: "无类别", edibility: INEDIBLE, eat_points: -2, discard_points: -1, role: SACRIFICE, synergy_tags: ["诅咒", "任务", "负面"], effect: null }),
];
