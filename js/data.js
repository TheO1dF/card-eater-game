...
const SHOP_CARD_DEFS = [
  ...
  card({ id: "C009", name: "卫星", rarity: "普通", max_copies: 2, type: "星体", edibility: INEDIBLE, eat_points: -2, discard_points: 1, role: ECONOMY, synergy_tags: ["星体", "餐盘", "经济", "规模"], effect: { kind: "gold_from_reserve", description: "每轮首次弃掉：若有未登场牌，结算金币 +1；每再多 4 张未登场牌再 +1（最多 +3）", trigger_action: "discard", step: 4, max_gold: 3, once_per_round: true } }),
